...
Il est intéressant et courant de vouloir travailler sur la base de l'ensemble des codages CIM-10, indépendamment de la position de codage (DP, DR, DAS ou DAD).  

Pour ce faire, nous allons constituer un tibble des codages CIM-10 pour chacune des 4 positions possibles de codage, en faisant en sorte que ces 4 tibbles aient les mêmes variables. Puis, nous "empilerons" les 4 tibbles.  
