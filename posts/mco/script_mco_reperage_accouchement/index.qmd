...
Ligne 8 : `mco_rss$ccam` est un tibble des variables CCAM liées aux RUM. Voir [Guide des scripts - Jeux de données](http://localhost:3479/guide_post.html#via-pmsisoft-standard)  
