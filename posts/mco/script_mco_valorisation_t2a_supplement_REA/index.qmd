...
Ligne 6 : `mco_rsa$rsa` est un tibble des variables de la partie fixe des RSA. Voir [Guide des scripts - Jeux de données](http://localhost:3479/guide_post.html#via-pmsisoft-standard)  
