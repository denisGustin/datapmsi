...
Ligne 6 : `mco_rsa$rsa` est un tibble des variables de la partie fixe des RSA. Voir [Guide des scripts - Jeux de données](https://www.datapmsi.com/guide_post#via-pmsisoft-standard)  
