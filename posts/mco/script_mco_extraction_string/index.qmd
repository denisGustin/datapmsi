...
Ligne 3 : `mco_rss$das` est un tibble des variables `das` associées aux RUM. Voir [Guide des scripts - Jeux de données](http://localhost:3479/guide_post.html#via-pmsisoft-standard)  
